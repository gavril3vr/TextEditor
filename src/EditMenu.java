...
public class EditMenu implements Menu, ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (s.equals("Search")) {
            ...
            //jd.getContentPane().add(panelOne, BorderLayout.NORTH);
            ...
            replaceBtn.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent actionEvent) {
                    ...
                    System.out.println("Text Area: " + textAreaString + "\nWonefield: " + findString + "\n Wtwofield: " + replaceString + isCaseSensitiveReplace);
                }
            });
